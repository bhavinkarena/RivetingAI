...
def send_email(recipient: str, doc_id:int, documentTeamName: str, firstName: str):
    ...
    message["Subject"] = (
        f"""{firstName} has shared secure a document with you in "{documentTeamName}""" ""
    )
...
<body>
    <div class="emailsection">
        ...
        <div class="subcontent">
            <div class="firstlink">
                <a href="https://rivetingai.onrender.com/document/{doc_id}" class="linkbtn">Click to Access {firstName}'s Document</a>
            </div>
            <div class="secondlink">
                <a href="#" class="link">Click this URL if the above button does not work:
                <span>https://rivetingai.onrender.com/document/{doc_id}</span></a>
            </div>
            <div class="Regards">
